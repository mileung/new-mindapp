			...
			let db = new SQLocalDrizzle({
				...
				onInit: (sql) => [
					sql`
						...
						CREATE INDEX IF NOT EXISTS idx_code_p1_p2_p3_p4 ON parts(code, p1, p2, p3, p4) WHERE code IN (5, 6);
						CREATE INDEX IF NOT EXISTS idx_code_p1_p4_p5_p6 ON parts(code, p1, p4, p5, p6) WHERE code IN (1, 2, 4);
						CREATE INDEX IF NOT EXISTS idx_code_p1_p2_p3 ON parts(code, p1, p2, p3) WHERE code IN (0, 1, 2, 3, 7);
						CREATE INDEX IF NOT EXISTS idx_code_p1_p3_p2 ON parts(code, p1, p3, p2) WHERE code IN (0);
						CREATE INDEX IF NOT EXISTS idx_code_p1_p3_p4 ON parts(code, p1, p3, p4) WHERE code IN (14, 15, 17);
						...
						CREATE INDEX IF NOT EXISTS idx_code_p1_p2 ON parts(code, p1, p2) WHERE code IN (13, 14, 15, 16, 18);
						CREATE INDEX IF NOT EXISTS idx_code_txt ON parts(code, txt) WHERE code IN (21);
						CREATE INDEX IF NOT EXISTS idx_code_p1 ON parts(code, p1) WHERE code IN (8, 9, 10, 11, 12, 19, 20, 21, 22, 23, 24, 25, 26, 27, 29);
						CREATE INDEX IF NOT EXISTS idx_code_p2 ON parts(code, p2) WHERE code IN (19, 20);
