...
export let pTable = sqliteTable(
	...
	(table) => [
		primaryKey({
			...
			// Makes the following indexes unnecessary for cloud db:
			// idx_code_p1_p2_p3_p4
			// idx_code_p1_p2_p3
			// idx_code_p1_p2
			// idx_code_p1
			// local-db.ts doesn't use Drizzle Studio so it should not have a primary_key_idx
